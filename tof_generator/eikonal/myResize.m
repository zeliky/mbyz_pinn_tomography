function mat_rs = myResize(varargin)
    ...
    %       
    % This function is taken from the k-Wave Toolbox (http://www.k-wave.org)
    % Copyright (C) 2009-2017 Bradley Treeby
    %
    % See also interp1, interp2, interp3

    % k-Wave is free software: you can
...
%     tic;
    ...
    % check inputs
    if myNumDim(mat) ~= length(varargin{2})
    ...
    % update command line status
%     disp([' my completed in ' scaleTime(toc)]);  
end
